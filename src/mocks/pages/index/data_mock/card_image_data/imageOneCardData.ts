...
import { IMAGE_ONE_SOURCE_LINK } from "../../../../../constants/mocks/pages/index/card_data_value/card_images_information/images_source_links/imageOneSourceLinkConstant";
import { CardsData } from "../../../../../types/pages/index/CardsData";

const IMAGE_ONE_CARD_DATA: CardsData = {
  creator: CREATOR_NAME,
  image: IMAGE_ONE_SOURCE_LINK,
  title: CARD_IMAGE_TITLE,
  link: CARD_EXTERNAL_REFERENCE_DATA_IMAGE_LINK,
};

export default IMAGE_ONE_CARD_DATA;
