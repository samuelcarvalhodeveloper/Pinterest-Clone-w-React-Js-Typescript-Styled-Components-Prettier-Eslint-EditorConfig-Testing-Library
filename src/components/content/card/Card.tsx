...
import showCardRippleEffect from "../../../utils/react/pages/index/card/toggle_ripple_effect/showCardRippleEffect";
import hideCardRippleEffect from "../../../utils/react/pages/index/card/toggle_ripple_effect/hideCardRippleEffect";
